...
[[ -f "$HOME/dotfiles/shell/external-eject.zsh" ]] && source "$HOME/dotfiles/shell/external-eject.zsh"
[[ -f "$HOME/dotfiles/shell/port-power.zsh" ]] && source "$HOME/dotfiles/shell/port-power.zsh"
